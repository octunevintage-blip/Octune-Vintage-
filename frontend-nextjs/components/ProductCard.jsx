  ...
  if (variant === 'trending') {
    return (
      <Link href={`/product/${product.slug}`} className="group block relative w-full h-full" style={{ perspective: '1000px' }}>
        <div className="relative w-full h-full aspect-[4/5] bg-vnv-light-gray overflow-hidden shadow-md transition-all duration-[600ms] ease-[cubic-bezier(0.23,1,0.32,1)] group-hover:-translate-y-3 group-hover:rotate-x-[2deg] group-hover:rotate-y-[-2deg] group-hover:shadow-[0_20px_40px_rgba(0,0,0,0.3)]">
          <Image 
          ...
          {/* Dark Overlay gradient for hover */}
          ...
          {/* Details appearing on hover */}
          <div className="absolute bottom-0 left-0 w-full p-5 translate-y-8 opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-[600ms] ease-[cubic-bezier(0.23,1,0.32,1)] z-20 flex flex-col justify-end">
