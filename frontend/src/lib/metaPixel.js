export const META_PIXEL_ID = '2289821805188406';

/**
 * Safe client-side wrapper to trigger Meta Pixel standard and custom events in React SPA.
...
export const trackEvent = (eventName, params = {}, eventId = null) => {
  ...
  if (typeof window.fbq === 'function') {
    if (eventId) {
      // Pass eventID as 4th parameter for Meta CAPI deduplication
