export const metadata = { title: 'Terms of Service | Octune Vintage' };
...
<p>
To report an issue, customers must contact us within the specified time after delivery and provide a clear unboxing video of both the product and the packaging.
</p>

<p>
The unboxing video must meet the following requirements:
</p>

<ul>
  <li>The video must be at least 1 minute and 30 seconds long.</li>
  <li>It must clearly show a 360-degree view of the sealed parcel before opening.</li>
  <li>The shipping label must be clearly visible before the package is opened.</li>
  <li>The entire video must be recorded in one continuous shot without any cuts, edits, or pauses.</li>
  <li>The reported issue or defect must be clearly visible in the video.</li>
</ul>

<p>
Requests that do not meet these requirements may not be eligible for review, return, or exchange.
</p>
        </section>
  ...
  <p>
    ...
    However, actual colors may vary slightly due to lighting, photography, and
...
<section>
  ...
  <p>
    ...
    Prices are subject to change at any time without prior notice. However,
    confirmed orders will not be affected by any subsequent price changes.
  </p>
</section>
...
<section>
  ...
  <p>
    Customers are responsible for providing accurate shipping details, contact
    information, and confirming the correct size before placing an order.
    Octune Vintage will not be responsible for failed deliveries caused by
    incorrect or incomplete addresses or invalid phone numbers.
  </p>
</section>
...
<section>
  ...
  <p>
    All content on this website, including images, text, branding, logos, and
    product descriptions, is the property of Octune Vintage and may not be
    copied, reused, distributed, or reproduced without prior written
    permission.
  </p>
</section>
...
<section>
  ...
  <p>
    For any order-related concerns, questions, or support, customers may
    contact Octune Vintage at:
    <br />
    <strong>Email:</strong> octunevintage@gmail.com
  </p>
</section>
      </div>
    </div>
