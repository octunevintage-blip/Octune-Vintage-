    ...
    <div className="container mx-auto px-4 md:px-8 py-12 md:py-20">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 lg:gap-20">
        <div className="lg:col-span-2">
          ...
          <div className="flex flex-col md:grid md:grid-cols-6 gap-6 items-center border-b border-vnv-gray/30 pb-8 relative group">
            ...
            <div className="absolute top-0 right-0 md:relative md:col-span-1 flex justify-end">
              <button onClick={clearCart} className="text-vnv-gray hover:text-vnv-black transition-colors p-2">
