...
export default function PrivacyPage() {
  return (
    <div className="container mx-auto px-6 lg:px-12 py-20 max-w-4xl">
      <h1 className="font-display text-4xl uppercase tracking-widest mb-12 border-b border-ink/10 pb-6">Privacy Policy</h1>
      <div className="space-y-8 text-sm text-ink/80 leading-relaxed">
        ...
        <section>
          <h2 className="font-display text-xl uppercase tracking-widest mb-4">Information We Collect</h2>
        ...
        <section>
          <h2 className="font-display text-xl uppercase tracking-widest mb-4">Payment Processing</h2>
