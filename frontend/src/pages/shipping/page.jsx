...
export default function ShippingPage() {
  return (
    <div className="container mx-auto px-6 lg:px-12 py-20 max-w-4xl">
      <h1 className="font-serif text-4xl uppercase tracking-widest mb-12 border-b border-ink/10 pb-6">Shipping & Returns</h1>
      <div className="space-y-8 text-sm text-ink/80 leading-relaxed">
        <section>
          <h2 className="font-serif text-xl uppercase tracking-widest mb-4">Shipping Policy</h2>
        ...
        <section>
          <h2 className="font-serif text-xl uppercase tracking-widest mb-4">All Sales Are Final</h2>
